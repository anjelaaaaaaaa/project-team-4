...
<html lang="en">	
	<head>
      ...
      function goPopup(){
    	...
    	function jusoCallBack(address,sido,gungu){
...
<%--                                         <input type="text" name="name" value="<%=dto.getH_name()%>"><br> --%>
		...
		<div id="callBackDiv">
<!-- 		<table> -->
<!-- 			<tr><td>도로명주소 전체(포멧)</td><td><input type="text"  style="width:500px;" id="address"  name="address" /></td></tr> -->
<!-- 			<tr><td>시도명        		</td><td><input type="text"  style="width:500px;" id="sido"  name="sido" /></td></tr> -->
<!-- 			<tr><td>시군구명        	</td><td><input type="text"  style="width:500px;" id="gungu"  name="gungu" /></td></tr> -->
<!-- 		</table> -->
										
                                    
                                      <div class="form-floating mb-3">
                                        <input class="form-control" name="roadFullAddr" id="roadFullAddr" type="text" placeholder="name@example.com" required title="입력하세요!">
                                        <label for="address"><i class="bi bi-star-fill text-warning"></i>주소를 입력하세요</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" name="siNm"  id="siNm" type="text" placeholder="name@example.com" required title="입력하세요!">
                                        <label for="sido"><i class="bi bi-star-fill text-warning"></i>위치정보를 입력하세요 (시,도)</label>
                                    </div>
                                    <div class="form-floating mb-3">
                                        <input class="form-control" name="sggNm" id="sggNm" type="text" placeholder="name@example.com" required title="입력하세요!">
